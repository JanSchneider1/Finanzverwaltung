...
<div id="page-container">
    <div id="content-wrap">
        ...
        <div class="container row"
             style=" background-color: #212529; margin: auto; margin-top: 20px; padding-top: 20px; width: 30%;">

            <form class="col-lg-2" action="analyticCalendar.php" method="post" id="last">
                <input type="hidden" name="start_date"
                       value="<?php echo $sd1->modify("first day of previous month")->format("y-m-d"); ?>">
                <input type="hidden" name="end_date"
                       value="<?php echo $ld1->modify("last day of previous month")->format("y-m-d"); ?>">
                <div style="text-align: left;">
                    <button class="btn btn-dark" onclick="$('#last').submit()"><span class="fa fa-caret-left"></span>
                    </button>
                </div>
            </form>
            ...
            <form class="col-lg-2" action="analyticCalendar.php" method="post" id="next">
                <input type="hidden" name="start_date"
                       value="<?php echo $sd2->modify("first day of next month")->format("y-m-d"); ?>">
                <input type="hidden" name="end_date"
                       value="<?php echo $ld2->modify("last day of next month")->format("y-m-d"); ?>">
                <div style="text-align: right;">
                    <button class="btn btn-dark"><span class="fa fa-caret-right" onclick="$('#next').submit()"></span>
                    </button>
                </div>
            </form>
        </div>
