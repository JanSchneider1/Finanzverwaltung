          ...
          <td>
            ...
            <div class="dropdown">
              <input class="input" style="display: none"
                     value="<?php echo $categoryID != null ? $categoryID : "Alle"; ?>"
        ...
        <form method="POST">
          <table class="table table-dark table-hover">
            ...
            <tr>
              ...
              <td><input class="form-control input-group-text input" type="text" name="addAccounting_name">
              </td>
              <td>
                <fieldset>
                  <!-- Dropdown: 'Kategorien' -->
                  <div class="dropdown">
                    ...
                    <button class="btn btn-dark dropdown-toggle hvr-grow" type="button"
                            id="dropdownMenu2"
              ...
              <td>
                ...
                <div class="dropdown">
                  ...
                  <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                    <li><a class="dropdown-item effect-underline" data-value="Einnahmen">Einnahmen</a>
                    </li>
                    <li><a class="dropdown-item effect-underline" data-value="Ausgaben">Ausgaben</a>
                    </li>
                  </ul>
                </div>
              </td>
