        ...
        <div class="container">
            <table class="table table-dark table-hover">
                ...
                <td>
                    <!-- Dropdown: Zeitraum -->
                    <div class="dropdown">
                        <button class="btn btn-dark dropdown-toggle hvr-grow" type="button" value="Alle" data-toggle="dropdown"
                                aria-haspopup="true" aria-expanded="true">
                            <?php echo $startDate != null ? "Eigen" : "Dieser Monat"; ?>
                            <span class="caret"></span>
                        </button>
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                            <li id="month"><a class="dropdown-item effect-underline" data-value="Dieser Monat">Diesen Monat</a>
                            </li>
                            <li id="day"><a class="dropdown-item effect-underline" data-value="Heute">Heute</a></li>
                            <li id="week"><a class="dropdown-item effect-underline" data-value="Diese Woche">Diese Woche</a>
                            </li>
                            <li id="year"><a class="dropdown-item effect-underline" data-value="Dieses Jahr">Dieses Jahr</a>
                            </li>
                ...
                <form method="post" action="accountingList.php">
                    ...
                    <td>
                        ...
                        <div class="dropdown">
                            <input class="input" style="display: none"
                                   value="<?php echo $categoryID != null ? $categoryID : "Alle"; ?>" type="text"
                                   name="category_filter">
                            <button class="btn btn-dark dropdown-toggle hvr-grow" type="button" data-toggle="dropdown"
                                    aria-haspopup="true" aria-expanded="true">
                    ...
                    <td><input class="form-control input" type="number" step="1" name="max_value"
                               ...
                               style="width:100px"></td>
                    <td>
                        <button class="btn btn-dark hvr-underline-from-left" id="btn_filter" type="submit" style="width:100px">
                            Suchen
                        </button>
                    </td>
                </form>
            ...
            <form method="POST">
                <table class="table table-dark table-hover">
                    ...
                    <tr>
                        ...
                        <td><input class="form-control input" type="number" name="addAccounting_value" min="0.01" step="0.25"
                                   value="1" style="width:100px"></td>
                        <td>
