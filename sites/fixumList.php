    ...
    <form method="POST" onsubmit="addFixum()">
      <tr>
        ...
        <th class="value"><input class="input-group-text" style="background: #31343b; color: white;" type="text"
                                 name="addFixum_name"></th>
        <th>
          <fieldset>
            <!-- Dropdown: 'Frequenz' -->
            <div class="dropdown">
              <input class="input" style="display: none" value="0" type="text" name="addFixum_frequency">
              <button class="btn btn-dark dropdown-toggle hvr-grow" type="button" id="dropdownMenu3"
        ...
        <th><input class="form-control input" type="number" name="addFixum_value" min="0.25" step="0.25" value="1"
                   style="width:100px"></th>
        <th style="text-align: end">
          <button type="button" class="btn btn-dark hvr-reveal" onclick="addFixum(this.form)"><span
